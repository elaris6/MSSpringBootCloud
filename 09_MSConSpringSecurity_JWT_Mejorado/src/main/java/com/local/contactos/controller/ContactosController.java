...
public class ContactosController {
	...
	/* Se modifica este método sobre el ejemplo original para que no devuelva nada,
	 * en lugar de boolean.
	 * Se modifican también por tanto la interfaz y la implementación de la capa de
	 * servicio. */
